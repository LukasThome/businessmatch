  ...
  list.then((l) => {
    ...
    <div class="card" id="cardId__${id}">
        <div class="titleContainer">
            ...
            <svg id="portfolioId__${id}" onclick="remove()" class="svgIcons" width="25px" height="25px" xmlns="http://www.w3.org/2000/svg" fill="#a00" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="w-6 h-6">
